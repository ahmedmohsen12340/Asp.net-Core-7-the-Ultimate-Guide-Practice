...
namespace Services
{
    public class StockService : IStocksService
    {
        ...
        public StockMarketDbContext _db;

        public StockService(StockMarketDbContext db)
        {
        ...
        public List<BuyOrderResponse> GetBuyOrders()
        {
            ...
            */
            return _db.BuyOrders.Select(buyorder=>buyorder.ToBuyOrderResponse()).ToList();
        }
        ...
        public List<SellOrderResponse> GetSellOrders()
        {
            ...
            */
            ...
            return _db.SellOrders.Select(sellorder => sellorder.ToSellOrderResponse()).ToList();
        }
    }
}
